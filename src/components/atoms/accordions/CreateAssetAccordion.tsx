  ...
  return (<Accordion transitionDuration={300} defaultValue={"1"} classNames={{}}>
    <Accordion.Item value={"1"}>
      ...
      <Accordion.Panel>
        <div className="grid grid-cols-9 gap-2">
          <div className="col-span-3">
            <InputField register={props.register} label="Serial Number" name="category" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          <div className="col-span-3">
          ...
          <div className="col-span-3">
            <InputField register={props.register} label="Project" name="name" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          <div className="col-span-3">
          ...
          <div className="col-span-3">
            <InputField register={props.register} label="Generated Asset Number" name="cost" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
    ...
    <Accordion.Item value={"2"}>
      ...
      <Accordion.Panel>
        <div className="grid grid-cols-9 gap-2">
          ...
          <div className="col-span-3">
            <InputField register={props.register} label="Currency" name="category" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          <div className="col-span-3">
          ...
          <div className="col-span-3">
            <InputField register={props.register} label="Purchase Date" name="category" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          ...
          <div className="col-span-3">
            <InputField register={props.register} label="Department" name="category" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          <div className="col-span-3">
            <InputField register={props.register} label="Class" name="category" />
            <AlertInput>{props.errors?.name?.message}</AlertInput>
          </div>
          <div className="col-span-3">

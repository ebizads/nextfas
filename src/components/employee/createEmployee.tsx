...
import DropzoneCMP from "../dropzone/dropzonecmp";
        ...
        <div>
                ...
                <div className="flex w-full flex-wrap gap-4 py-2.5">
                    ...
                    <div className="flex w-[32%] flex-col">
                        ...
                        <InputField
                            ...
                            type={"text"} label={""} name={"profile.middle_name"} register={register} />
                    </div>
                    <div className="flex w-[32%] flex-col">
                        <label className="sm:text-sm">Last Name</label>
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"profile.last_name"} register={register} />
                    </div>
                </div>
            ...
            /> */}
                            ...
                            styles={(theme) => ({
                                item: {
                                    ...
                                    '&[data-selected]': {
                                        '&, &:hover': {
                                            backgroundColor:
                                                theme.colorScheme === 'light' ? theme.colors.orange[3] : theme.colors.orange[1],
                    ...
                    <div className="flex w-[32%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"employee_id"} register={register} />
                    ...
                    <div className="flex w-[32%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"position"} register={register} />
          ...
          /> */}
                    ...
                    <div className="flex w-[32%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"subsidiary"} register={register} />
                    ...
                    <div className="flex w-[32%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"profile.phone_no"} register={register} />
                    ...
                    <div className="flex w-full flex-wrap gap-4 py-2.5">
                        <div className="flex w-[18%] flex-col">
                            ...
                            <InputField
                                className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                                type={"text"} label={""} name="address.street" register={register} />
                        </div>
                        <div className="flex w-[18%] flex-col">
                            <label className="sm:text-sm">Barangay</label>
                            <InputField
                                className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                                type={"text"} label={""} name={"address.state"} register={register} />
                        ...
                        <div className="flex w-[18%] flex-col">
                            ...
                            <InputField
                                className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                                type={"text"} label={""} name={"address.city"} register={register} />
                        </div>
                        <div className="flex w-[18%] flex-col">
                            <label className="sm:text-sm">Zip Code</label>
                            <InputField
                                className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                                type={"text"} label={""} name={"address.zip"} register={register} />
                        ...
                        <div className="flex w-[18%] flex-col">
                            ...
                            <InputField
                                className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                                type={"text"} label={""} name={"address.country"} register={register} />
                ...
                <div className="flex w-full flex-wrap gap-4 py-2.5">
                    <div className="flex w-[48%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"address.billing_address"} register={register} />
                    ...
                    <div className="flex w-[48%] flex-col">
                        ...
                        <InputField
                            className="focus-outline appearance-none  border border-black py-2 px-3 leading-tight text-gray-700 focus:outline-none"
                            type={"text"} label={""} name={"address.shipping_address"} register={register} />

                        <AlertInput>{errors?.address?.shipping_address?.message}</AlertInput>
                    </div>
                </div>
                        ...
                        <div className="flex  w-full justify-center items-center">
                            {props.isLoading === true ? (
                                ...
                                <Image
                                    ...
                                    withPlaceholder
                                    placeholder={<Text align="center">This image </Text>}></Image>
                            ) : (

      ...
      <Accordion.Item value={"3"}>
        ...
        <Accordion.Panel>
          <div className="grid grid-cols-9 gap-2">
            ...
            <div className="col-span-3">
              <TypeSelect
                title={"Annual Method Entry"}
                placeholder={"Pick annual method entry"}

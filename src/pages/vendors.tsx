...
const Vendors = () => {
  ...
  const { mutate } = trpc.vendor.create.useMutation({
    onSuccess: () => {
        ...
        <section className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {checkboxes.length > 0 && (
                <button
                  ...
                  onClick={() => {
                    deleteVendor.mutate(checkboxes)
                    setCheckboxes([])
                  }}
                >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  const downloadableVendors = vendors.map((vendor) => {
                    if (vendor?.["address"]) {
              ...
              <div className="grid grid-cols-10 gap-y-9 gap-x-4">
                ...
                <div className="col-span-5">
                  <label className="sm:text-sm">
                    Mobile Number: {`(use " , " for multiple Mobile numbers)`}
                  </label>
                  <input
                    type="text"
                    className="curs w-full rounded-md border-2 border-gray-400 bg-transparent px-4 py-2 text-gray-600 outline-none  ring-tangerine-400/40 placeholder:text-sm focus:border-tangerine-400 focus:outline-none focus:ring-2"
                    onKeyDown={(e) => {
                ...
                <div className="col-span-5">
                  {/* <InputField
                    ...
                    type="text"
                  /> */}
                  <label className="mb-2 sm:text-sm">Fax/Phone Number</label>
                  <input
                    // disabled={!isEditable}

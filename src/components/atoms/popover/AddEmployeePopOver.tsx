    ...
    >
      ...
      <Popover.Dropdown>
        ...
        <div className="flex flex-col text-sm">
          <button onClick={() => { props.setAddSingleRecord(true), props.setEmployeeId(generateEmployeeId()) }} className="px-6 py-2 hover:bg-tangerine-100">Add single record</button>

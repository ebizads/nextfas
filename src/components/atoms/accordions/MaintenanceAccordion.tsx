...
export const maintananceNavigations = [
  {
    name: "Maintenance",
    ...
    subType: [
      {
        icon: "fa-sharp fa-solid fa-location-crosshairs",
...
const MaintenanceNavAccordion = (props: {
  paths: string[]
  minimize: boolean
    ...
    <div>
      {!props.minimize ? (
        ...
        <div className="flex flex-col">
          {maintananceNavigations.map((page, idx) => (
            <button
              key={idx}
...
export default MaintenanceNavAccordion

        ...
        <div className="flex flex-wrap gap-4 py-2.5">
          ...
          <div className="flex w-[32%] flex-col">
            ...
            {/* <InputField
              ...
              register={register}
            /> */}
            <p className="peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent py-[3.23%] px-0  text-sm text-gray-900 focus:border-tangerine-500 focus:outline-none focus:ring-0">{`${props.employee.employee_id}`}</p>
          </div>
          <div className="flex w-[32%] flex-col">

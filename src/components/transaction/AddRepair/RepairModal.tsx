...
export const RepairDetailsModal = (props: {
  ...
  const { mutate } = trpc.assetRepair.edit.useMutation({
    onSuccess() {
      setIsVisible(true)
  ...
  const { handleSubmit, reset, setValue } = useForm<RepairEdit>({
          ...
          <div className="">
            <div className="flex w-full flex-row justify-between gap-7">
              <div className="flex w-full flex-col py-2">
                ...
                <p className="text-base ">{props.asset?.asset?.name ?? "--"}</p>
              </div>
              <div className="flex w-full flex-col py-2">
              ...
              <div className="flex w-full flex-col py-2">
                ...
                <p className="text-base">
                  {props.asset?.asset?.alt_number
                    ? props.asset?.asset?.alt_number?.length > 0
                      ? props.asset?.asset?.alt_number
                      : "--"
                    : "--"}
                </p>
            ...
            {props.asset?.repairStatus === "approved" && (
              <div className="flex w-full flex-row justify-between gap-7">
                <div className="flex w-full flex-col">
                  <label className="font-semibold">Comments</label>
                  <Textarea
            ...
            {(props.asset?.repairStatus === "rejected" ||
              props.asset?.repairStatus === "done" ||
              props.asset?.repairStatus === "cancelled") && (
              <div className="flex w-full flex-row justify-between gap-7">
                <div className="flex w-full flex-col">
                  <label className="font-semibold">Comments</label>
                  <Textarea

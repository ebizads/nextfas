  ...
  const parseEmployeesData = (data: unknown[]) => {
    ...
    dupEmployeeList.forEach((emp) => {
      ...
      const data_structure = {
        ...
        profile: {
          id: (emp as (string | number | null)[])[30] as number,
          first_name: (emp as (string | number)[])[31] as string,
          middle_name: (emp as (string | number | null)[])[32] as string,
          last_name: (emp as (string | number)[])[33] as string,
